    ...
    <div className="sidebar">
      ...
      <div className="sidebar-menu">
        {menuItems.map(item => {
          ...
          const canViewParent = isSuperAdmin || hasPermission(item.permission);
                  ...
                  <div className="sidebar-dropdown-items">
                    {item.subItems.map(subItem => {
                      if (isSuperAdmin || hasPermission(subItem.permission)) {
                        return (
                          <Link key={subItem.path} to={subItem.path} className="sidebar-link">
                            {subItem.name}
                          </Link>
                        );
                      }
